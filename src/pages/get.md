...
**if you submitted a project to magazine:** you might receive one for free, or be able to get one at a discount! details aren't confirmed yet, so wait a little longer :)

you can buy one from the flavortown shop! (link pending)

it costs 🍪 (pending) cookies - that's around (pending) hours of coding. once you've shipped your project, you can buy it using cookies, and you don't have to pay!
